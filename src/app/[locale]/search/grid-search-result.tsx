...
export function GridSearchResult() {
        ...
        return (
          <Card key={i} className="overflow-hidden">
            ...
            <CardContent className="p-3">
              <Link href={`/item/${obj._id}`} className="font-bold text-sm">
                <span dangerouslySetInnerHTML={{ __html: formatArrayValue(obj._source._label) }} />
              </Link>
            </CardContent>
          </Card>
        )
