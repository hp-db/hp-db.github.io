          ...
          <Card className="transition-shadow duration-200 hover:shadow-md">
            ...
            <CardContent>
              <ul className="list-disc pl-6 space-y-2 text-sm">
                {locale === 'ja' ? (
                  <>
                    <li>2026年4月15日: IDコンコーダンス表・引用ボタン・フッターナビゲーション等を追加。<Link href="/about/changelog" className="ml-1 text-primary hover:underline">→ 更新履歴</Link></li>
                  ...
                  <>
                    <li>15, Apr., 2026: Added ID Concordance table, citation buttons, footer navigation, and more. <Link href="/about/changelog" className="text-primary hover:underline">→ Full changelog</Link></li>
