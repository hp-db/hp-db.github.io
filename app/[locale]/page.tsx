...
function HomeContent() {
  ...
  return (
    <div>
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-teal-900/70 to-teal-800/50" />
        <div className="relative text-center text-white">
          <h1 className="text-4xl font-bold mb-6 tracking-tight">{t(title)}</h1>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc pl-6 space-y-2 text-sm">
                {locale === 'ja' ? (
                  <>
                    <li><a href="https://researchmap.jp/Masakatsu-Nagai/">永井正勝</a>, 東京大学 東京大学附属図書館アジア研究図書館上廣倫理財団寄付研究部門 特任准教授</li>
                    <li><a href="https://researchmap.jp/wakit/">和氣愛仁</a>, 筑波大学 人文社会系 准教授</li>
                    <li><a href="https://researchmap.jp/takahashi.yona">高橋洋成</a>, 東京外国語大学 アジア・アフリカ言語文化研究所 特任研究員</li>
                    <li><a href="https://researchmap.jp/nakamura.satoru/">中村覚</a>, 東京大学 史料編纂所 助教</li>
                  </>
                ) : (
                  <>
                    <li><a href="https://researchmap.jp/Masakatsu-Nagai/?lang=english">Masakatsu NAGAI</a>, Associate Professor, Uehiro Project for the Asian Research Library, The University of Tokyo.</li>
                    ...
                    <li><a href="https://researchmap.jp/nakamura.satoru/?lang=english">Satoru NAKAMURA</a>, Assistant Professor, Historiographical Institute, The University of Tokyo.</li>
                  </>
                )}
              </ul>
            </CardContent>
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  return {
    title: 'Hieratische Paläographie DB',
  }
}
